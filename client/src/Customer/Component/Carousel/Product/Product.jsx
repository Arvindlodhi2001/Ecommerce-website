  ...
  return (
    <div className="bg-white">
      <div>
        ...
        <main className="mx-auto  px-4 sm:px-7 lg:px-20">
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-8 lg:grid-cols-6">
              {/* Filters */}
              ...
              <div className="lg:col-span-5 w-full  ">
                <div className="flex flex-wrap justify-evenly bg-white py-5 ">
                  {data &&
                    data.map((item, key) => (
                      <div key={key}>
                        <ProductCard />
